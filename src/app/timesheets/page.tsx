  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-ink-100 p-12 text-center">
        ...
        <p className="text-[15px] font-medium text-ink-700">No timesheet entries yet</p>
        <p className="text-[12px] text-ink-400 mt-2 max-w-md mx-auto">
          Timesheet entries will appear here once you start logging time against your projects.
        </p>
      </div>
    </div>
  )
